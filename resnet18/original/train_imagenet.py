...
parser.add_argument('--data', type=str, default='/work/mji/imagenet/', help='location of the data corpus')
...
#  criterion_smooth = criterion_smooth.cuda()
  ...
  model = ResNet18(criterion_smooth)
...
#        hue=0.2),
  ...
  bo.export_finn_onnx(model.module.cpu(), (1,3,224,224),'/PATH/NAME.onnx')
