...
parser.add_argument('--pretrained_model_path', type=str, default='/data/volume_2/code/resnet18_nas_w8a8_v2_n1/models/resnet18_img_nas_w8a8_r8_v2_n1_30.pth', help='path of pretrained model')
