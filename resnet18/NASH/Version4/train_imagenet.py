...
parser.add_argument('--pretrained_model_path', type=str, default='/data/volume_2/code/resnet18_nas_w8a8/models/resnet18_img_nas_a8w8_r8_n8_90.pth', help='path of pretrained model')
