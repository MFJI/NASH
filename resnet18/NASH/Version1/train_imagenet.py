...
parser.add_argument('--pretrained_model_path', type=str, default='/data/volume_2/code/resnet18_nas_w8a8_v1_n1/models/resnet18_img_nas_w8a8_r8_v1_n1_60_2.pth', help='path of pretrained model')
...
#        hue=0.2),
  ...
  bo.export_finn_onnx(model.module.cpu(), torch.randn(1,3,224,224),'/PATH/NAME.onnx')
